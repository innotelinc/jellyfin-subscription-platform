    ...
    <>
      ...
      <main className="relative flex flex-1 items-center overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-md px-4 py-16 text-center sm:px-6">
          <div className="animate-pop-in mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-white/15 bg-white/[0.04] text-3xl">
            🚫
          </div>
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/"
              className="rounded-full border border-white/15 px-7 py-3 text-sm font-medium transition-colors hover:border-white/30"
            >
              Home
            </Link>
          </div>
